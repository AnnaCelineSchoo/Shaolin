    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `${process.env.PUBLIC_URL}/workouts/pushup.json`
        );
    ...
    <div>
      ...
      <p>
        ...
        <p className="no-print">
          For guidance on proper push-up form, refer to the following video:
          <IconButton
            ...
            href="https://www.youtube.com/watch?v=IODxDxX7oi4&t=5s&ab_channel=Calisthenicmovement"
            target="_blank"
